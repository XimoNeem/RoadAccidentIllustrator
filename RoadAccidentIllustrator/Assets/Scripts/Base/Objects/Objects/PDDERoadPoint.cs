...
[System.Serializable]
public class PDDERoadPoint : PDDERoad
{
    ...
    public PDDERoadPoint parentPoint;
    public PDDERoadPoint connectedPoint;
    ...
    [Space]
    public List<PDDERoadPoint> chilsPoints;
    ...
    void AddPoint()
    {
        ...
        foreach (var item in FindObjectsOfType<PDDERoadPoint>())
        {
            if (item.selected)
            {
    ...
    public void SetConnectedPoint(PDDERoadPoint point)
    {
