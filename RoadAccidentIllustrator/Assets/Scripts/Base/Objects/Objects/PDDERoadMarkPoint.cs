...
public class PDDERoadMarkPoint : PDDERoadMark
{
    ...
    public PDDERoadMarkPoint parentPoint;
    public PDDERoadMarkPoint connectedPoint;
    [Space]
    public List<PDDERoadMarkPoint> chilsPoints;
    ...
    public override void ApplySettings()
    {
        ...
        List<PDDERoadMarkPoint> pointsToChanges = new List<PDDERoadMarkPoint>();
    ...
    void AddPoint()
    {
        ...
        foreach (var item in FindObjectsOfType<PDDERoadMarkPoint>())
        {
            if (item.selected)
            {
    ...
    public void SetConnectedPoint(PDDERoadMarkPoint point)
    {
